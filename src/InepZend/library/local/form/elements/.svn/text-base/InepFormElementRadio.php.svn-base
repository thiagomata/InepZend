...
/**
 * Classe de Extensão do Elemento Radio do Zend Form
 *
 * @author Thiago Henrique Ramos da Mata <thiago.mata@inep.gov.br>
 * @date 02/12/2010
 *
 */
class InepFormElementRadio extends \Zend_Form_Element_Radio implements InepFormElementInterface
{
    /**
