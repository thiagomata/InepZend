...
/**
 * Classe de Extensão do Elemento Select do Zend Form
 *
 * @author Thiago Henrique Ramos da Mata <thiago.mata@inep.gov.br>
 * @date 02/12/2010
 *
 */
class InepFormElementSelect extends \Zend_Form_Element_Select implements InepFormElementInterface
{
    /**
