...
/**
 * Classe de Extensão do Elemento Checkbox do Zend Form
 *
 * @author Thiago Henrique Ramos da Mata <thiago.mata@inep.gov.br>
 * @date 02/12/2010
 *
 */
class InepFormElementCheckbox extends \Zend_Form_Element_Checkbox implements InepFormElementInterface
{
    /**
     ...
     * @return InepFormElementCheckbox
     */
