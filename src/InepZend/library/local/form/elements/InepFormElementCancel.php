...
/**
 * Classe de Extensão do Elemento Cancel do Zend Form
 *
 * @author Thiago Henrique Ramos da Mata <thiago.mata@inep.gov.br>
 * @date 02/12/2010
 *
 */
class InepFormElementCancel extends InepFormElementSubmit
{
    /**
    ...
    /**
     * Inicializa o Elemento Cancel com os valores padrao
     */
