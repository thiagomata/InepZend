...
/**
 * Classe de Extensão do Elemento Password do Zend Form
 *
 * @author Thiago Henrique Ramos da Mata <thiago.mata@inep.gov.br>
 * @date 02/12/2010
 *
 */
class InepFormElementPassword extends \Zend_Form_Element_Password implements InepFormElementInterface
{
    /**
     ...
     * @return InepFormElementPassword
     */
