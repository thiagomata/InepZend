...
/**
 * Classe de Extensão do Elemento File do Zend Form
 *
 * @author Thiago Henrique Ramos da Mata <thiago.mata@inep.gov.br>
 * @date 02/12/2010
 *
 */
class InepFormElementFile extends \Zend_Form_Element_File implements InepFormElementInterface
{
    /**
