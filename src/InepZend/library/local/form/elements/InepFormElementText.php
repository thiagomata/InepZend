...
/**
 * Classe de Extensão do Elemento Text do Zend Form
 *
 * @author Thiago Henrique Ramos da Mata <thiago.mata@inep.gov.br>
 * @date 02/12/2010
 *
 */
class InepFormElementText extends \Zend_Form_Element_Text implements InepFormElementInterface
{
    /**
