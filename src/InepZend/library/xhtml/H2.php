 ...
 * @see xhtml\P
 * @see xhtml\Section
 * @link http://htmldog.com/reference/htmltags/h2/
 * @link http://developer.mozilla.org/en/HTML/Element/h2/
 */
class H2 extends abstractEntity\TextEntity
{
    /**
     * XML Tag Name
     *
