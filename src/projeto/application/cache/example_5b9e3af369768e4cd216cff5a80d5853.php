...
$oTagAdd1 = new xhtml\template\Add();
$oTagAdd1->setRefid( 'teste' );
$oTagP2 = new xhtml\P();
$oTagText3 = new xhtml\Text();
$oTagText3->setTextContent( 'Outra Coisa' );
$oTagP2->addChild( $oTagText3) ;
$oTagAdd1->addChild( $oTagP2) ;
$oTagBody1->addChild( $oTagAdd1) ;
$oTagIf1 = new xhtml\template\XmlIf();
$oTagIf1->setValue( '{#false#}' );
$oTagText4 = new xhtml\Text();
$oTagText4->setTextContent( 'é falso' );
$oTagIf1->addChild( $oTagText4) ;
$oTagElse1 = new xhtml\template\XmlElse();
$oTagText5 = new xhtml\Text();
$oTagText5->setTextContent( '{# date( "h:i:s" ) #}' );
$oTagElse1->addChild( $oTagText5) ;
$oTagIf1->addChild( $oTagElse1) ;
$oTagBody1->addChild( $oTagIf1) ;
$oTagDiv2 = new xhtml\Div();
$oTagText6 = new xhtml\Text();
$oTagText6->setTextContent( '{# 1 + 2 #} abc {# $this->nome #}' );
$oTagDiv2->addChild( $oTagText6) ;
...
$oTagText7->setTextContent( '{# $this->key #}
                        {# $this->oi #}' );
$oTagLi1->addChild( $oTagText7) ;
...
$oTagText13->setTextContent( 'EMPTY!' );
$oTagEmpty1->addChild( $oTagText13) ;
...
$oTagText14->setTextContent( 'Chave' );
$oTagTh1->addChild( $oTagText14) ;
$oTagTr1->addChild( $oTagTh1) ;
$oTagTh2 = new xhtml\Th();
$oTagText15 = new xhtml\Text();
$oTagText15->setTextContent( 'Nome' );
$oTagTh2->addChild( $oTagText15) ;
...
$oTagText16->setTextContent( '{# $this->key + 1 #}º Carro' );
$oTagTd1->addChild( $oTagText16) ;
$oTagTr2->addChild( $oTagTd1) ;
$oTagTd2 = new xhtml\Td();
$oTagText17 = new xhtml\Text();
$oTagText17->setTextContent( '{# $this->item #}' );
$oTagTd2->addChild( $oTagText17) ;
...
$oTagText18 = new xhtml\Text();
$oTagText18->setTextContent( 'Sem Carros' );
$oTagSpan2->addChild( $oTagText18) ;
